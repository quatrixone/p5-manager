...
export const BUILTIN_INPUT_SCRIPTS = [
  {
    id: 'builtin:restart',
    name: 'Restart PS5',
    description: 'Hold PS to open the Power overlay, pick Restart, confirm.',
    script: [
      "#reboot",
      "ps",
      "wait 1794",
  ...
  {
    id: 'builtin:standby',
    name: 'Enter Rest Mode',
    description: 'Hold PS to open the Power overlay and confirm the default option.',
    script: [
      '// Open the Power overlay (hold PS for ~1.5s)',
      'ps 1500',
      'wait 1200',
      '// "Enter Rest Mode" is highlighted by default',
      'cross',
    ].join('\n'),
  },
  {
  ...
  },
  {
    ...
    description: 'Single press of the PS button — closes Control Center / overlays.',
    script: [
      'ps',
    ].join('\n'),
  },
